...
When you want to test against a `zod` schema (zod: validation library) with `vitest` (vitest: testing library), `mock-filelist` enables you to use mock object which is treated as File, FileList, or File[].
