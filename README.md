...
When you want to test against a `zod` schema (zod: validation library) with `vitest` (vitest: testing library), you can use `mock-filelist` as a mock for an object in File, FileList or File[].
